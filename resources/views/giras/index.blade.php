<x-plantilla>
        ...
        <div class="card redondeado m-1 p-4 shadow bg-degrade">
            <div class="row d-flex justify-content-around">
                ...
                <div class="col my-auto text-right">
                    <x-adminlte-button label="Presupuesto semanal" data-toggle="modal" data-target="#modalPurple" class="btn btn-success btn-sm" icon="fas fa-dollar-sign" />
    ...
    <x-adminlte-modal id="modalPurple" title="Presupuesto semanal" theme="navy" icon="fas fa-dollar-sign" size='md'>
        <div class="row">
            <x-adminlte-input id="txt_presupuesto" name="erro" placeholder="Ingrese su presupuesto semanal" type="number"
                fgroup-class="col" />
        </div>
